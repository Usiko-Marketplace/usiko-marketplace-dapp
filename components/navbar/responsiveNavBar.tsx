...
const ResponsiveNavBar = ({
  ...
  return (
    <nav className="flex flex-1 justify-end pr-4">
      ...
      >
        <article
          className={`flex h-screen w-full flex-wrap justify-between overflow-y-auto bg-black py-5 lg:h-auto lg:overflow-visible lg:bg-transparent lg:py-0 lg:pt-0`}
        >
          <ul
            className={`flex w-full flex-col justify-start gap-4 space-y-5 lg:flex-1 lg:flex-row lg:justify-center lg:space-y-0`}
          >
